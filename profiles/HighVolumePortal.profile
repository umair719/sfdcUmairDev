<?xml version="1.0" encoding="utf-8"?><Profile xmlns="http://soap.sforce.com/2006/04/metadata"><custom>false</custom><userLicense>High Volume Customer Portal</userLicense><applicationVisibilities>
        <application>CandidateMgmt</application>
        ...
        <layout>Campaign_Event__c-Campaign Event Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>Candidate__c-Candiate Layout</layout>
    </layoutAssignments><layoutAssignments>
        ...
        <layout>Contact__c-Attendee Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>ContentVersion-General</layout>
    </layoutAssignments><layoutAssignments>
        <layout>Contract-Contract Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>Customer_Satisfaction_Survey__c-Customer Satisfaction Survery Layout</layout>
    </layoutAssignments><layoutAssignments>
        ...
        <layout>Group_Donor__c-Group Donor Layout</layout>
    </layoutAssignments><layoutAssignments>
        ...
        <layout>Precinct__c-Precinct Layout</layout>
    </layoutAssignments><layoutAssignments>
